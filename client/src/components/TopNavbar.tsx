...
import { MdAccountCircle, MdLogout, MdEdit, MdCalendarToday } from "react-icons/md";
...
const TopNavbar = () => {
  ...
  const handleReservations = () => navigate("/reservations");
  ...
  return (
    <div className="w-full fixed top-0 left-0 flex justify-between items-center bg-[#161b22]/95 p-4 shadow-md border-b border-[#30363d] z-10">
      ...
      >
        ...
        <div className="text-xl font-bold text-white hover:underline">CabanApp</div>
      </div>
          ...
          {dropdownOpen && (
            <div className="absolute right-0 mt-2 w-44 bg-[#21262d] border border-[#30363d] rounded-lg shadow-lg z-20 py-1 space-y-1">
              ...
              >
                ...
                <span className="truncate">Rezervările mele</span>
              </button>
              <button
